...
INSERT INTO `foodlist` (`ftype`,`fid`, `fname`, `fprice`, `fdescription`, `fimage`, `manager`, `foodstatus`,`frestaurents`) VALUES
('food',20, 'Hummus', '14', 'with sourdough, crispy chickpeas & zaatar', '1.avif', 'ravis', 'available','ravis hotel'),
('food',21, 'Chicken Parma', '27', 'schnitzel topped with Napoli sauce, ham and cheese with chips & dressed leaves', '2.avif', 'ravis', 'available','ravis hotel'),
('food',22, 'Snapper Fritters (3)', '10', 'with parmesan aioli', '3.avif', 'ravis', 'available','ravis hotel'),
('food',23, 'Taphouse Fried Chicken', '16', 'with southern mayonnaise','4.avif', 'ravis', 'available','ravis hotel'),
('food',25, 'Salt & Pepper Popcorn Tofu', '26', 'with lemongrass dressing','5.avif', 'qwe', 'available','ravis hotel'),
('beer',28, 'Stomping Ground Big Sky Hazy Pale', '7.5', 'A Gentle haze, big tropical fruit and citrus flavours, balanced bitterness and a refreshing finish. - 4.3% (VIC)','6.avif', 'qwe', 'available','ravis hotel'),
('beer',29, 'Stomping Ground Bunker Porter', '7.8', 'Rich in chocolate and roast characters, our porter is also dark, mysterious and full of secrets. - 5.8% (VIC)','7.avif', 'qwe', 'available','ravis hotel'),
('wine',30, 'Swell Season Rose', '13(Glass)', ' ','8.avif', 'qwe', 'available','ravis hotel'),
('wine',31, 'Dune Blewitt Springs Shiraz', '14(Glass)', ' ','9.avif', 'qwe', 'available','ravis hotel'),
('cold drinks',32, 'Coke', '4.5', ' ','10.avif', 'qwe', 'available','ravis hotel');
