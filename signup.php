...
<div class="jumbotron pt-2" style="height: 130px;">
	<h2>Hi Guest,<br> Welcome to <span style="color:green;">The Local Taphouse</span></h2>
	<p class="pt-0" style="font-size: 21px;">Get started by creating your account</p>
</div>
