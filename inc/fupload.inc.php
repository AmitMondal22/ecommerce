 ...
 if (isset($_POST['submit'])) {
    ...
    if (empty($fname) || empty($fprice) || empty($fdescription) || empty($file)) {
    	...
    	if ($fileerror === 0) {
    			...
    			$sql = "insert into foodlist (ftype, fname, fprice, fdescription, frestaurents, fimage, manager, foodstatus) 
 		            values ('$ftype','$fname', '$fprice', '$fdescription', '$rname', '$filenewname', '$manager', '$foodstatus');";
