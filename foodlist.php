...
<body>
        ...
        <li class="nav-item pr-1">
          <form method="POST" class="form-inline mt-1" action="cart.php">
            <button class="btn btn-light btn-outline-success btn-md"><a href='cart.php'><i class="fas fa-cart-plus"></i></a>
              ...
              ?>
              <span class="badge badge-danger"><?php if (isset($total_quantity)) {
                                                  echo $total_quantity;
                                                } ?></span>
            </button>
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-item">
      <img src="images/slide001.jpg" class="d-block w-100 img-responsive" alt="slider2" style="height: 180px;">
    ...
    <div class="carousel-item">
      <img src="images/slide003.jpg" class="d-block w-100 img-responsive" alt="slider3" style="height: 180px;">
      <div class="carousel-caption d-none d-md-block">
        <h5><button>Play Game</button></h5>
        <p>To win exciting offers and Vouchers</p>
      </div>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/slide002.jpg" class="d-block w-100 img-responsive" alt="slider1" style="height: 180px;">
        <div class="carousel-caption d-none d-md-block">
          <h5><button type="button" onclick="App()">
              <script src="/virtual-tasting-game/src/App.js"></script>
              Play Game
  ...
  <!--jumbotron code-->
  <div class="jumbotron text-center pt-2">
    <h1>Welcome To THE TAPHOUSE CLUB <i class="fas fa-utensils"></i></h1>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <?php
        $sql = "select * from foodlist order by fid;";
        $result = mysqli_query($con, $sql);
        $resultcheck = mysqli_num_rows($result);
                    ...
                    <form method="POST" action="inc/cartcheck.inc.php?fid=<?php echo $row['fid']; ?>">
                      <div class="card">
                        ...
                        <div class="card-body text-center">
                          ...
                          if ($check == 'available') {
                          ?>
                            <button class="btn btn-success addToCartBtn" name="submit"><i class="fa fa-cart-plus"></i> Add To Cart</button>
                            <script>
                              document.addEventListener('DOMContentLoaded', function() {
                                var addToCartBtn = document.querySelector('.addToCartBtn');

                                addToCartBtn.addEventListener('click', function() {
                                  // Your logic to add items to the cart goes here
